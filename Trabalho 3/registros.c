...
void Procura_Campo(FILE *arq2){
    ...
    int cont = 0,num_reg = 0, num_pagdisc = 0, proc_insc, reg_encontrado = 0, contador = 0; /*contadores utilizados*/
    int tam_arq, tam_pag; /*inteiro para o tamanho do arquivo*/
    ...
    if(strcmp(opcao_campo, "nroInscricao") == 0){
        ...
        printf("Número de páginas de disco acessadas: %d",num_pagdisc); /*caso contrÃ¡rio imprime o nÃºmerdo de pÃ¡ginas acessadas*/
        }
    }
